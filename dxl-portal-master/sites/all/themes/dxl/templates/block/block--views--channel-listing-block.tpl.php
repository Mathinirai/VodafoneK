            ...
            <div class="spring">
                        ...
                        <div class="grid mb-30">
                            ...
                            <div class="grid__item grid__item--1/3 grid__item--middle hide--sm hide--md">
                                <p class="heading heading--5 heading--center heading--leading heading--trailing">
                                    Showing
                                    <strong>
                                        <?php echo $channel_listing_display_count; ?> of <?php echo $channel_listing_total_count; ?>
                                    </strong>
                                    Channels
                                </p>
                            </div>
                ...
                <table class="table table--alt table--list hide--md hide--sm">
                    ...
                    <tbody class="table__body" id="product-listing-table">
                      <?php foreach ($channel_listing as $keys => $channel_listing_node) { ?>
                        <tr class="table__tr">
                            <td class="table__td">
                                <a href="/<?php echo drupal_get_path_alias('node/'.$channel_listing_node->nid); ?>" class=""><?php echo  $channel_listing_node->node_title; ?></a>
                            </td>
                            <td class="table__td">
                                <?php 
                                    $api_croosrespondence = $api_north = $api_north_seemore = array();
                                    if(!empty($channel_listing_node->_field_data['nid']['entity']->field_apis_reference)){ 
                                        $k=1;$i=1; 
                                        foreach ($channel_listing_node->_field_data['nid']['entity']->field_apis_reference['und'] as $key_apis => $value_apis) {
                                            $link_node = node_load($value_apis['target_id']);
                                            if ($link_node->field_api_type['und'][0]['value'] == 'south'){
                                               $api_croosrespondence_mobile[$channel_listing_node->nid][$link_node->nid] = $link_node->title; 
                                               ...
                                               $api_north_mobile[$channel_listing_node->nid][$link_node->nid] = $link_node->title; 
                            ...
                            <td class="table__td">
                                <?php 
                                    ...
                                    if(!empty($channel_listing_node->_field_data['nid']['entity']->field_microservices_reference)){ 
                                        $k=1;
                                        foreach ($channel_listing_node->_field_data['nid']['entity']->field_microservices_reference['und'] as $key_apis => $value_apis) {
                                            $link_node = node_load($value_apis['target_id']);
                                            $microservices_node_mobile[$channel_listing_node->nid][$link_node->nid] = $link_node->title;
                                            if($k < 3 ) $api_north[$link_node->nid] = $link_node->title;
                                            else $api_north_seemore[$link_node->nid] = $link_node->title;
                                            $k++;
                                        }
                            ...
                            <td class="table__td">
                                <?php echo count($channel_listing_node->_field_data['nid']['entity']->field_usecase_reference['und']);?>
                            </td>
                            <td class="table__td">
                                <?php echo count($channel_listing_node->field_field_markets);?>
                            </td>
                            <td class="table__td">
                                    <ul>
                ...
                <div class="js-accordion accordion accordion--spaced hide--lg align--left" data-js="_accordion">
                        ...
                        <!-- ACCORDION ITEM 1 | HEADING -->
                        <?php foreach ($channel_listing as $keys => $channel_listing_m) { ?>
                        <div class="js-accordion-item accordion__item">
                            <h3 class="js-accordion-heading accordion__heading">
                                <span class="chevron">
                                    <span class="chevron__text">
                                        <?php echo  $channel_listing_m->node_title; ?>
                                    </span>
                                    <span class="chevron__container accordion__chevron">
                            ...
                            <div class="js-accordion-content accordion__content accordion__content--wide accordion__content--collapse ">
                                ...
                                <!-- SUBGROUP 1 -->
                                <?php if(!empty($microservices_node_mobile[$channel_listing_m->nid])){ ?>
                                <div class="accordion__content--subgroup">
                                    ...
                                    <!-- LINK TILE -->
                                    <?php foreach ($microservices_node_mobile[$channel_listing_m->nid] as $key_mobile => $value_mobile) {?>                                    
                                                ...
                                                <span class="media media--middle">
                                                    <span class="media__body">
                                                        <span
                                                            ...
                                                            <?php echo count($channel_listing_m->_field_data['nid']['entity']->field_usecase_reference['und']);?>
                                                        </span>
                                                    </span>
                                                </span>
                                            </span>
                                ...
                                <!-- SUBGROUP 3 -->
                                <?php if(!empty($api_north_mobile[$channel_listing_m->nid])){ ?>
                                <div class="accordion__content--subgroup">
                                    <!-- SUBGROUP TITLE -->
                                    <p class="accordion__content--header">
                                        API
                                    ...
                                    <!-- LINK TILE -->
                                    <?php foreach ($api_north_mobile[$channel_listing_m->nid] as $key_mobile => $value_mobile) {?>
                                    <a href="/<?php echo drupal_get_path_alias('node/'.$key_mobile); ?>" class="link link--tile link--tile--accordion">
                                        <span class="chevron">
                                            <span class="chevron__text">
                                                <span class="media media--middle">
                                            ...
                                            <span class="chevron__text">
                                                <span class="media media--middle">
                                                    <span class="media__body">
                                                        <span
                                                            class="link__heading heading heading--light heading--5 no-gutter--all ">
                                                            <?php echo count($channel_listing_m->field_field_markets);?>
                                                        </span>
                                                    </span>
                                                </span>
                                            </span>
                                ...
                                <!-- SUBGROUP 5 -->
                                <?php if(!empty($api_croosrespondence_mobile[$channel_listing_m->nid])){ ?>
                                <div class="accordion__content--subgroup">
                                    <!-- SUBGROUP TITLE -->
                                    <p class="accordion__content--header">
                                        API Correspondence
                                    ...
                                    <!-- LINK TILE -->
                                    <?php foreach ($api_croosrespondence_mobile[$channel_listing_m->nid] as $key_mobile => $value_mobile) {?>
                                    <a href="/<?php echo drupal_get_path_alias('node/'.$key_mobile); ?>" class="link link--tile link--tile--accordion ">
                                        <span class="chevron">
                                            <span class="chevron__text">
                                                <span class="media media--middle">
                ...
                <?php if($channel_listing_display_count >= 10 ) { ?>
                <div class="align--center">
                    <a href="/apis?page=<?php echo $limit; ?>" class="button button--primary mt-40">
                        Load more
                    </a>
                </div>
                <?php } elseif($channel_listing_display_count == 0) { ?>
                <div class="align--center">
