            ...
            <div class="spring">
                        ...
                        <div class="grid mb-30">
                            ...
                            <div class="grid__item grid__item--1/3 grid__item--middle hide--sm hide--md">
                                <p class="heading heading--5 heading--center heading--leading heading--trailing">
                                    Showing
                                    <strong>
                                        <?php echo $microservices_listing_display_count; ?> of <?php echo $microservices_listing_total_count; ?>
                                    </strong>
                                    Microservices
                                </p>
                            </div>
                ...
                <table class="table table--alt table--list hide--md hide--sm">
                    ...
                    <tbody class="table__body" id="product-listing-table">
                      <?php foreach ($microservices_listing as $microservices_node) { ?>
                        <tr class="table__tr">
                            <td class="table__td">
                                <a href="/<?php echo  drupal_get_path_alias('node/'.$microservices_node->nid); ?>" class=""><?php echo  $microservices_node->node_title; ?></a>
                            </td>
                            <td class="table__td">
                                <?php 
                                    $api_croosrespondence = $api_north = $api_north_seemore = array();
                                    if(!empty($microservices_node->_field_data['nid']['entity']->field_apis_reference)){ 
                                        $k=1;$i=1; 
                                        foreach ($microservices_node->_field_data['nid']['entity']->field_apis_reference['und'] as $key_apis => $value_apis) {
                                            $link_node = node_load($value_apis['target_id']);
                                            if ($link_node->field_api_type['und'][0]['value'] == 'south'){
                                               $api_croosrespondence_mobile[$microservices_node->nid][$link_node->nid] = $link_node->title; 
                                               ...
                                               $api_north_mobile[$microservices_node->nid][$link_node->nid] = $link_node->title; 
                            ...
                            <td class="table__td">
                                <?php echo count($microservices_node->_field_data['nid']['entity']->field_usecase_reference['und']);?>
                            </td>
                            <td class="table__td">
                                <?php 
                                    $api_north = $api_north_seemore = array();
                                    if(!empty($microservices_node->_field_data['nid']['entity']->field_channel_reference)){ 
                                        $k=1;
                                        foreach ($microservices_node->_field_data['nid']['entity']->field_channel_reference['und'] as $key_apis => $value_apis) {
                                            $link_node = node_load($value_apis['target_id']);
                                            $channel_node_mobile[$microservices_node->nid][$link_node->nid] = $link_node->title;
                                            if($k < 3 ) $api_north[$link_node->nid] = $link_node->title;
                                            else $api_north_seemore[$link_node->nid] = $link_node->title;
                                            $k++;
                                        }
                            ...
                            <td class="table__td">
                                <?php echo count($microservices_node->field_field_markets);?>
                            </td>
                            <td class="table__td">
                                    <ul>
                ...
                <div class="js-accordion accordion accordion--spaced hide--lg align--left" data-js="_accordion">
                        ...
                        <!-- ACCORDION ITEM 1 | HEADING -->
                        <?php foreach ($microservices_listing as $microservices_node_m) { ?>
                        <div class="js-accordion-item accordion__item">
                            <h3 class="js-accordion-heading accordion__heading">
                                <span class="chevron">
                                    <span class="chevron__text">
                                        <?php echo  $microservices_node_m->node_title; ?>
                                    </span>
                                    <span class="chevron__container accordion__chevron">
                            ...
                            <div class="js-accordion-content accordion__content accordion__content--wide accordion__content--collapse ">
                                ...
                                <!-- SUBGROUP 1 -->
                                <?php if(!empty($api_north_mobile[$microservices_node_m->nid])){ ?>
                                <div class="accordion__content--subgroup">
                                    ...
                                    <!-- LINK TILE -->
                                    <?php foreach ($api_north_mobile[$microservices_node_m->nid] as $key_mobile => $value_mobile) {?>
                                            ...
                                            <span class="chevron__text">
                                                <span class="media media--middle">
                                                    <span class="media__body">
                                                        <span
                                                            class="link__heading heading heading--light heading--5 no-gutter--all ">
                                                            <?php echo count($microservices_node_m->_field_data['nid']['entity']->field_usecase_reference['und']);?>
                                                        </span>
                                                    </span>
                                                </span>
                                            </span>
                                ...
                                <!-- SUBGROUP 3 -->
                                <?php if(!empty($channel_node_mobile[$microservices_node_m->nid])){ ?>
                                <div class="accordion__content--subgroup">
                                    <!-- SUBGROUP TITLE -->
                                    <p class="accordion__content--header">
                                        Channels
                                    ...
                                    <!-- LINK TILE -->
                                    <?php foreach ($channel_node_mobile[$microservices_node_m->nid] as $key_mobile => $value_mobile) {?>                                    
                                    <a href="/<?php echo drupal_get_path_alias('node/'.$key_mobile); ?>" class="link link--tile link--tile--accordion">
                                        <span class="chevron">
                                            <span class="chevron__text">
                                                <span class="media media--middle">
                                            ...
                                            <span class="chevron__text">
                                                <span class="media media--middle">
                                                    <span class="media__body">
                                                        <span
                                                            class="link__heading heading heading--light heading--5 no-gutter--all ">
                                                            <?php echo count($microservices_node_m->field_field_markets);?>
                                                        </span>
                                                    </span>
                                                </span>
                                            </span>
                                ...
                                <!-- SUBGROUP 5 -->
                                <?php if(!empty($api_croosrespondence_mobile[$microservices_node_m->nid])){ ?>
                                <div class="accordion__content--subgroup">
                                    <!-- SUBGROUP TITLE -->
                                    <p class="accordion__content--header">
                                        API Correspondence
                                    ...
                                    <!-- LINK TILE -->
                                    <?php foreach ($api_croosrespondence_mobile[$microservices_node_m->nid] as $key_mobile => $value_mobile) {?>
                                    <a href="/<?php echo drupal_get_path_alias('node/'.$key_mobile); ?>" class="link link--tile link--tile--accordion ">
                                        <span class="chevron">
                                            <span class="chevron__text">
                                                <span class="media media--middle">
                ...
                <?php if($microservices_listing_display_count >= 10 ) { ?>
                <div class="align--center">
                    <a href="/apis?page=<?php echo $limit; ?>" class="button button--primary mt-40">
                        Load more
                    </a>
                </div>
                <?php } elseif($microservices_listing_display_count == 0) { ?>
                <div class="align--center">
