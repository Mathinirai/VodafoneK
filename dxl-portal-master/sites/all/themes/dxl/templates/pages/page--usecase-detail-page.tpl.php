...
$domains = $node->field_domains['und'];
$business_capabilities = $node->field_business_capabilities['und'];
...
$channel_count = count($node->field_channel_reference['und']);
                        ...
                        <div class="grid grid--gutter">
                            <div class="grid__item grid__item--gutter grid__item--1/3">
                                ...
                                <small class="heading heading--light">
                                  ...
                                  <?php foreach ($domains as $domains_key => $domains_value) { ?>                                          
                                        <small class="heading heading--regular">
                                            <?php print $domains_value['taxonomy_term']->name; ?>
                                        </small>
                                  <?php }?>
                                <?php }?>
                            </div>
                            <div class="grid__item grid__item--gutter grid__item--2/3">
                                <?php if(!empty($business_capabilities)) { ?>
                                <small class="heading heading--light">
                                    Business Capabilities
                                </small>
                                  <?php foreach ($business_capabilities as $business_capabilities_key => $business_capabilities_value) { ?>                                          
                                        <small class="heading heading--regular">
                                            <?php print $business_capabilities_value['taxonomy_term']->name; ?>
                                        </small>
                                  <?php }?>
                                <?php }?>
                            </div>
        ...
        <div class="spring">
            ...
            <div class="grid grid--gutter">
                ...
                <div class="grid__item grid__item--gutter grid__item--2/3 grid__item--sm-1/1">
                    ...
                    <h4 class="heading heading--4 mb-20">
                        <?php if(!empty($goals)) print get_label('usecase_detail_page_field_goals'); ?>
                    </h4>
                    ...
                    <h4 class="heading heading--4 mb-20">
                        <?php if(!empty($operations)) print get_label('usecase_detail_page_field_operations'); ?>
                    </h4>
                    <ul class="list list--reset">
                    ...
                    <div data-js="_simpleTabs" class="js-tabs tabs tabs--secondary js-dynamic-content-listener">
                        ...
                        <div id="tab-1" class="js-tabs-content tabs__content " style="display: block;">
                            ...
                            <div class="js-accordion accordion accordion--spaced hide--lg align--left" data-js="_accordion">
                                ...
                                <?php foreach ($node->field_apis_reference['und'] as $key_apis_mobile => $value_apis_mobile) {
                                ...
                                <div class="js-accordion-item accordion__item">
                                    ...
                                    <div class="js-accordion-content accordion__content accordion__content--wide accordion__content--collapse ">
                                        <!-- SUBGROUP 1 -->
                                        <?php  if(!empty($apis_node_mobile->field_apis_reference['und'])) { ?>
                                        <div class="accordion__content--subgroup">
                                            <!-- SUBGROUP TITLE -->
                                            <p class="accordion__content--header">
                                                API
                                            </p>
                                            <?php foreach($apis_node_mobile->field_apis_reference['und'] as $usecase_node_apis_mobile) { 
                                                    $api_name_mobile = node_load($usecase_node_apis_mobile['target_id'])->title;
                                                    ?>
                                            <!-- LINK TILE -->
                                            <a href="<?php echo '/node/'.$usecase_node_apis_mobile['target_id']; ?>" class="link link--tile link--tile--accordion ">
                                                <span class="chevron">
                                                    <span class="chevron__text">
                                        ...
                                        <div class="accordion__content--subgroup">
                                            ...
                                            <?php foreach($apis_node_mobile->field_channel_reference['und'] as $usercase_node_microservice_mobile) { 
                                                    $channel_name_mobile = node_load($usercase_node_microservice_mobile['target_id'])->title;
                                                    ?>
                                            <!-- LINK TILE -->
                                            <a href="<?php echo '/node/'.$usercase_node_microservice_mobile['target_id']; ?>" class="link link--tile link--tile--accordion ">
                                                <span class="chevron">
                                                    <span class="chevron__text">
                                                        <span class="media media--middle">
                                                            <span class="media__body">
                            ...
                            <div class="js-accordion accordion accordion--spaced hide--lg align--left" data-js="_accordion">
                                ...
                                <div class="js-accordion-item accordion__item">
                                    ...
                                    <div class="js-accordion-content accordion__content accordion__content--wide accordion__content--collapse ">
                                        ...
                                        <!-- SUBGROUP 5 -->
                                        <?php if(!empty($microservice_market_mobile)) : ?>
                                        <div class="accordion__content--subgroup">
                                            <!-- SUBGROUP TITLE -->
                                            <p class="accordion__content--header">
                                                Markets
                                                ...
                                                <span class="chevron">
                                                    <span class="chevron__text">
                                                        <span class="media media--middle">
                                                            <span class="media__body">
                                                                <span class="link__heading heading heading--light heading--5 no-gutter--all ">
                                                                    <?php echo implode(', ', $microservice_market_mobile);?>
                                                                </span>
                                                            </span>
                                                        </span>
                                                    </span>
                    ...
                    <!-- CHANNELS -->
                    <?php if(!empty($node->field_channel_reference['und'])){ ?>
                    <h4 class="heading heading--4 mb-20">
                        Channels
                    </h4>
                    <ul class="grid grid--gutter">
                    ...
                    <?php 
                    foreach ($node->field_channel_reference['und'] as $key_channel => $value_channel) {
                        $channel_node = node_load($value_channel['target_id']);
                        ?>                   
                        <li class="grid__item grid__item--gutter grid__item--gutter-vertical grid__item--1/2 grid__item--sm-1/1">
                            <a href="/<?php echo drupal_get_path_alias('node/'.$channel_node->nid); ?>" class="card card--white card--link">

                                <div class="card__content">
                                    <div class="grid grid--gutter">
                                        <div class="grid__item grid__item--gutter grid__item--middle grid__item--6/7">
                                            <h4 class="heading heading--4 no-gutter--all">
                                                <?php echo  $channel_node->title; ?>
                                            </h4>
                                        </div>
                                        <div
                                        ...
                                        <div class="grid pt-10">
                                            <?php if(!empty($channel_node->field_relation['und'])){ ?>
                                            <div class="grid__item grid__item--gutter grid__item--gutter-vertical grid__item--1/3">
                                                <small class="heading heading--light">
                                                    Relation
                                                </small>
                                                <?php foreach ($channel_node->field_relation['und'] as $relation) { ?>
                                                    <p class="box-item box-item--dark">
                                                        <?php echo taxonomy_term_load($relation['tid'])->name;?>
                                                    </p>                                                
                                                <?php }?>
                                            </div>
                                            <?php }?>
                                            <?php if(!empty($channel_node->field_segment['und'])){ ?>
                                            <div class="grid__item grid__item--gutter grid__item--gutter-vertical grid__item--2/3">
                                                <small class="heading heading--light">
                                                    Segment
                                                </small>
                                                <ul class="grid grid--gutter">
                                                    <?php foreach ($channel_node->field_segment['und'] as $segment) { ?>
                                                    <li class="grid__item grid__item--gutter grid__item--1/2">
                                                        <p class="box-item box-item--dark">
                                                            <?php echo taxonomy_term_load($segment['tid'])->name;?>
                                                        </p>
                                                    </li>
                                                    <?php }?>
                                                </ul>
                                            ...
                                            <?php }?>
                                            <div
                                                class="grid__item grid__item--gutter grid__item--gutter-vertical grid__item--1/3">
                                                <small class="heading heading--light">
                                                    APIs
                                                </small>
                                                <p class="box-item box-item--dark">
                                                    <?php echo count($channel_node->field_apis_reference['und']); ?>
                                                </p>
                                            </div>
                                            <div
                                                class="grid__item grid__item--gutter grid__item--gutter-vertical grid__item--1/3">
                                                ...
                                                <p class="box-item box-item--dark">
                                                    <?php echo count($channel_node->field_microservices_reference['und']); ?>
                                                </p>
                                            </div>
                                            <div
                                                class="grid__item grid__item--gutter grid__item--gutter-vertical grid__item--1/3">
                                                ...
                                                <p class="box-item box-item--dark">
                                                    <?php echo count($channel_node->field_usecase_reference['und']); ?>
                                                </p>
                                            </div>
                                            <div
                                                class="grid__item grid__item--gutter grid__item--gutter-vertical grid__item--1/3">
                                                ...
                                                <p class="box-item box-item--dark">
                                                    <?php echo count($channel_node->field_markets['und']); ?>
                                                </p>
                                            </div>
                                        </div>
