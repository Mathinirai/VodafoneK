                        ...
                        <div class="grid grid--gutter">
                            ...
                            <?php if(!empty($type)) { ?>                                
                                <small class="heading heading--light">
                                  ...
                                  <?php foreach ($type as $type_key => $type_value) { ?>                                          
                                        <small class="heading heading--regular">
                                            <?php print $type_value['taxonomy_term']->name; ?>
                                        </small>
                                  <?php } ?>
                            <?php } ?>
                            </div>
            ...
            <div class="grid grid--gutter">
                ...
                <div class="grid__item grid__item--gutter grid__item--2/3 grid__item--sm-1/1">
                  ...
                  <!-- DESCRIPTION -->
                    ...
                    <h4 class="heading heading--4 mb-20">
                        <?php if(!empty($goals)) print get_label('product_item_detail_page_field_goals'); ?>
                    </h4>
                    ...
                    <h4 class="heading heading--4 mb-20">
                        <?php if(!empty($operations)) print get_label('product_item_detail_page_field_operations'); ?>
                    </h4>
                    <ul class="list list--reset">
                                    ...
                                    foreach ($node->field_apis_reference['und'] as $key_apis => $value_apis) {
                                        ...
                                        if(!empty($apis_node->field_markets['und'])) {
                                            foreach ($apis_node->field_markets['und'] as $key_mr => $value_mr) {
                                                $mr_name = taxonomy_term_load($value_mr['tid'])->name;
                                                $apis_market[] = $mr_name;
                                            }
                                        }
                                    ...
                                    foreach ($node->field_apis_reference['und'] as $key_apis_mobile => $value_apis_mobile) {
                                        ...
                                        if(!empty($apis_node_mobile->field_markets['und'])) {
                                            foreach ($apis_node_mobile->field_markets['und'] as $key_mr_mobile => $value_mr_mobile) {
                                                $mr_name_mobile = taxonomy_term_load($value_mr_mobile['tid'])->name;
                                                $apis_market_mobile[] = $mr_name_mobile;
                                            }
                                        }
                                        ?>
                                <div class="js-accordion-item accordion__item">
                                    ...
                                    <div class="js-accordion-content accordion__content accordion__content--wide accordion__content--collapse ">
                                        ...
                                        <div class="accordion__content--subgroup">
                                            ...
                                            <?php foreach($apis_node_mobile->field_channel_reference['und'] as $apis_node_channel_mobile) { 
                                                    $channel_name_mobile = node_load($apis_node_channel_mobile['target_id'])->title;
                                                    ?>
                                            <!-- LINK TILE -->
                                            <a href="<?php echo 'node'.$apis_node_channel_mobile['target_id']; ?>" class="link link--tile link--tile--accordion ">
                                                <span class="chevron">
                                                    <span class="chevron__text">
                                                        <span class="media media--middle">
                                                            <span class="media__body">
                                ...
                                <div class="js-accordion-item accordion__item">
                                    ...
                                    <div class="js-accordion-content accordion__content accordion__content--wide accordion__content--collapse ">
                                        ...
                                        <div class="accordion__content--subgroup">
                                            ...
                                            <?php 
                                                if(!empty($apis_node_mobile->field_microservices_reference['und'])){ foreach($apis_node_mobile->field_microservices_reference['und'] as $apis_node_microservice_mobile) { 
                                                    $microservice_name_mobile = node_load($apis_node_microservice_mobile['target_id'])->title;
                                                    ?>
                                            <!-- LINK TILE -->
                                            <a href="<?php echo '/node/'.$apis_node_microservice_mobile['target_id']; ?>" class="link link--tile link--tile--accordion ">
                                        ...
                                        <div class="accordion__content--subgroup">
                                            ...
                                            <?php 
                                                if(!empty($apis_node_mobile->field_channel_reference['und'])){ foreach($apis_node_mobile->field_channel_reference['und'] as $apis_node_channel_mobile) { 
                                                    $channel_name_mobile = node_load($apis_node_channel_mobile['target_id'])->title;
                                                    ?>
                                            <!-- LINK TILE -->
                                            <a href="<?php echo 'node'.$apis_node_channel_mobile['target_id']; ?>" class="link link--tile link--tile--accordion ">
